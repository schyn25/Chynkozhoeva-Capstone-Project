...
We use the `vegan` function `diversity` to calculate various diversity indices and specify which index we want to use as one of the arguments for the function.
